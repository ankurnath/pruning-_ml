...
if __name__ == "__main__":
    ...
    mcts_model_save_folder = f'pretrained/MCTSPruner/{problem}/{train_dist}'
    # os.makedirs(save_folder,exist_ok=True)
    model = PolicyValueGCN()
    save_file_path = os.path.join(mcts_model_save_folder,'best.pth')
    ...
    gnn_save_folder =  f'pretrained/GNNpruner/{problem}/{train_dist}'
    gnn_load_model_path = os.path.join(gnn_save_folder ,'best_model.pth')
    pruner.model.load_state_dict(torch.load(gnn_load_model_path,weights_only=False))
